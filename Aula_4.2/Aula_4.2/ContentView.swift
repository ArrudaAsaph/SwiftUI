...
struct ContentView: View {
    ...
    var musicas = [
        ...
        Musicas(Title: "Rhythm of the Stars", Sub_Title: "Celestial Vibes", photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvv-cfXDXnkrzXwt7jndUxDJgMJVocsNvn9A&s"),
                ...
                ScrollView{
                    VStack{
                        ...
                        ForEach(musicas, id: \.self) { a in
                            ...
                            NavigationLink(destination: MusicPage(musica: a)){
                            HStack{
